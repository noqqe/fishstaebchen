...
complete -c poetry -n '__fish_poetry_fba08e63e8e33757_complete_no_subcommand' -l directory -d 'The working directory for the Poetry command (defaults to the current working directory).'
complete -c poetry -n '__fish_poetry_fba08e63e8e33757_complete_no_subcommand' -l help -d 'Display help for the given command. When no command is given display help for the list command.'
complete -c poetry -n '__fish_poetry_fba08e63e8e33757_complete_no_subcommand' -l no-ansi -d 'Disable ANSI output.'
complete -c poetry -n '__fish_poetry_fba08e63e8e33757_complete_no_subcommand' -l no-cache -d 'Disables Poetry source caches.'
...
complete -c poetry -n '__fish_poetry_fba08e63e8e33757_complete_no_subcommand' -l no-plugins -d 'Disables plugins.'
...
# commands
complete -c poetry -f -n '__fish_poetry_fba08e63e8e33757_complete_no_subcommand' -a about -d 'Shows information about Poetry.'
complete -c poetry -f -n '__fish_poetry_fba08e63e8e33757_complete_no_subcommand' -a add -d 'Adds a new dependency to pyproject.toml.'
...
complete -c poetry -f -n '__fish_poetry_fba08e63e8e33757_complete_no_subcommand' -a cache
...
complete -c poetry -f -n '__fish_poetry_fba08e63e8e33757_complete_no_subcommand' -a check -d 'Validates the content of the pyproject.toml file and its consistency with the poetry.lock file.'
complete -c poetry -f -n '__fish_poetry_fba08e63e8e33757_complete_no_subcommand' -a config -d 'Manages configuration settings.'
complete -c poetry -f -n '__fish_poetry_fba08e63e8e33757_complete_no_subcommand' -a debug
...
complete -c poetry -f -n '__fish_poetry_fba08e63e8e33757_complete_no_subcommand' -a env
...
complete -c poetry -f -n '__fish_poetry_fba08e63e8e33757_complete_no_subcommand' -a export -d 'Exports the lock file to alternative formats.'
...
complete -c poetry -f -n '__fish_poetry_fba08e63e8e33757_complete_no_subcommand' -a self
...
complete -c poetry -f -n '__fish_poetry_fba08e63e8e33757_complete_no_subcommand' -a source
...
complete -c poetry -f -n '__fish_poetry_fba08e63e8e33757_complete_no_subcommand' -a update -d 'Update the dependencies as according to the pyproject.toml file.'
complete -c poetry -f -n '__fish_poetry_fba08e63e8e33757_complete_no_subcommand' -a version -d 'Shows the version of the project or bumps it when a valid bump rule is provided.'
